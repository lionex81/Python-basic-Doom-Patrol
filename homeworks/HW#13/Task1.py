...
#raise BridgeNoMoney('Anna', 'is looking for the money')
...
def bridge(person):
      print(
          f'{person.name} pass the bridge with enough money.Current balance: {person.get_balance}.Tag: {person.get_tag}')


if __name__ == '__main__':
 anna = Person(name='Anna', money=60)
 bridge(anna)
